...
//			System.out.println(" parameter is "+image);
			...
			carinfo.setName(carname);
			carinfo.setYear(year);
			carinfo.setDoorCount(doorCount);
			carinfo.setDriveTrain(driveTrain);
			carinfo.setTransmission(transmission);
			carinfo.setBodyStyle(bodyStyle);
			carinfo.setImage(image);
			
			insert.InsertIntoDB(carinfo);
		} 
